...
buttons:{normal:"DTTT_button ui-button ui-state-default"},collection:{container:"DTTT_collection ui-buttonset ui-buttonset-multi"}})};"function"===typeof define&&define.amd?define(["static/scripts/jquery/datatables/js/jquery","datatables"],b):"object"===typeof exports?b(require("static/scripts/jquery/datatables/js/jquery"),require("datatables")):jQuery&&b(jQuery,jQuery.fn.dataTable)})(window,document);
